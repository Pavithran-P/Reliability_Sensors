...
proc create_root_design { parentCell } {
  ...
  set RO1_BTI0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AXI_BTI_2:1.0 RO1_BTI0 ]
  set_property -dict [ list \
   CONFIG.num_oscillators {5} \
 ] $RO1_BTI0

  # Create instance: RO2_BTI1, and set properties
  set RO2_BTI1 [ create_bd_cell -type ip -vlnv xilinx.com:user:AXI_BTI:1.0 RO2_BTI1 ]
  set_property -dict [ list \
   CONFIG.num_oscillators {5} \
 ] $RO2_BTI1
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M14_AXI [get_bd_intf_pins RO1_BTI0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M14_AXI]
  ...
  assign_bd_address -offset 0x43CE0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RO1_BTI0/S00_AXI/S00_AXI_reg] -force
