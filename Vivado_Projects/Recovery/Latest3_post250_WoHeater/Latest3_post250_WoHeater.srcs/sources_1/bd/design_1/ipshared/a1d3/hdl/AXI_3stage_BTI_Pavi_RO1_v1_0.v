...
`timescale 1 ns / 1 ps
	...
	module AXI_3stage_BTI_Pavi_RO2_v1_0 #
	(
...
// Instantiation of Axi Bus Interface S00_AXI
	...
	AXI_3stage_BTI_Pavi_RO2_v1_0_S00_AXI # ( 
		.C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
		.C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
	) AXI_3stage_BTI_Pavi_RO2_v1_0_S00_AXI_inst (
	    .En(En),
	    //.En2(En2),	
    ...
    begin : CRO
        //if (i<(num_oscillators/2)) begin
            LUT6_NAND NAND(                   //NAND Gate      
                .control(En),
                .in_sig(~w[i*4+3]),           //One of the input is inverted 
                .out_sig(w[i*4])
                );
